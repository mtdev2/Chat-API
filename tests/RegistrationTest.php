let<#name #> : <#Class #>
                   ...
                   protocol
               RegistrationTest extends PHPUnit_Framework_TestCase
> <#Protocol #> {
}
        ...
        public function
        testRegistrationIdentityfileCanBeCreatedWithoutArguments()
            {
            $number = '1234567890';
            ...
            $expectedFile = sprintf('%s%s%sid.%s.dat', __DIR__ . '/../src',
            DIRECTORY_SEPARATOR, Constants::DATA_FOLDER.DIRECTORY_SEPARATOR,
            $number);
